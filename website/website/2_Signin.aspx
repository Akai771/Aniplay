    ...
    <form id="form1" runat="server">
        <section class="joinclass firstsection">
            <div class="box-main" style="padding-top:10em">
                ...
                <asp:Label style="color:white" Class="text-big" ID="Label1" runat="server" Text="Sign in"></asp:Label>
                ...
                <p>
                    <asp:Button Class="button" ID="Button1" runat="server" OnClick="Button1_Click" Text="Sign in" />
                </p>
                <p>
                    &nbsp;</p>
                <p>
